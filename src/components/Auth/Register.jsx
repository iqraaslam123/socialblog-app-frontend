...
// //   return (
// //     <div className="min-h-screen flex" style={{ background: 'var(--theme-bg)' }}>
...
// //           <h1 className="text-5xl font-black mb-4">Join Us</h1>
// //           <p className="text-xl opacity-80">Start your journey today</p>
// //         </div>
// //       </div>
...
// //             <h2 className="text-4xl font-black mb-2" style={{ color: 'var(--primary)' }}>Create Account</h2>
...
// //             ].map(f => (
// //               <div key={f.key}>
// //                 <label className="block text-sm font-semibold mb-2" style={{ color: 'var(--primary)' }}>{f.label}</label>
// //                 <input type={f.type} required value={form[f.key]} placeholder={f.placeholder}
// //                   onChange={e => setForm(p => ({ ...p, [f.key]: e.target.value }))}
// //                   className="w-full px-4 py-3 rounded-xl border-2 outline-none transition-all text-sm font-medium bg-white dark:bg-gray-900 dark:text-white"
...
// //               className="w-full py-3 rounded-xl text-white font-bold text-sm tracking-wide transition-all hover:opacity-90 hover:shadow-lg disabled:opacity-50"
// //               style={{ background: 'var(--primary)' }}>
...
// // import framer motion for subtle animations and enhanced UX
...
//   return (
//     <div className="min-h-screen flex selection:bg-indigo-500 selection:text-white" style={{ background: 'var(--theme-bg)' }}>
...
//         <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-emerald-500/20 rounded-full blur-3xl mix-blend-screen animate-pulse" />
//         <div className="absolute bottom-1/3 left-1/4 w-72 h-72 bg-blue-500/20 rounded-full blur-3xl mix-blend-screen animate-pulse delay-500" />

//         <motion.div 
//           initial={{ opacity: 0, scale: 0.95 }}
//           animate={{ opacity: 1, scale: 1 }}
//           transition={{ duration: 0.8, ease: "easeOut" }}
//           className="relative z-10 text-center text-white px-16 max-w-xl"
//         >
//           <motion.div 
//             animate={{ y: [0, -12, 0] }}
...
//           <h1 className="text-6xl font-black mb-6 tracking-tight leading-none bg-clip-text text-transparent bg-gradient-to-r from-white via-slate-100 to-blue-200">
//             Join Community
//           </h1>
          
//           <p className="text-xl opacity-75 font-light leading-relaxed max-w-md mx-auto">
//             Create your account today and unlock full access to interactive profiles, dynamic updates, and tech sharing.
//           </p>
//         </motion.div>
...
//             <h2 className="text-4xl font-black tracking-tight mb-3" style={{ color: 'var(--primary)' }}>
//               Create Account
//             </h2>
//             <p className="text-gray-400 dark:text-gray-500 font-medium">
//               Get started by establishing your unique global profile.
//             </p>
//           </div>
...
//                   onChange={e => setForm(p => ({ ...p, [f.key]: e.target.value }))}
//                   className="w-full px-5 py-3.5 rounded-xl border-2 outline-none transition-all text-sm font-medium bg-white dark:bg-gray-900 dark:text-white shadow-sm focus:shadow-md"
//                   style={{ borderColor: 'rgba(var(--primary-rgb, 229, 231, 235), 0.2)' }}
//                   onFocus={e => e.target.style.borderColor = 'var(--primary)'}
//                   onBlur={e => e.target.style.borderColor = 'rgba(229, 231, 235, 0.7)'} 
//                 />
//                 {f.key === 'password' && (
...
//               type="submit" 
//               disabled={loading}
//               className="w-full py-4 mt-2 rounded-xl text-white font-bold text-sm tracking-wide transition-all relative overflow-hidden flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
//               style={{ background: 'var(--primary)' }}
//             >
//               {loading ? (
//                 <>
...
//             <Link to="/login" className="font-bold transition-colors hover:opacity-80" style={{ color: 'var(--primary)' }}>
//               Sign in here →
//             </Link>
//           </p>
//         </motion.div>
