...
//           <h1 className="text-5xl font-black mb-4 leading-tight">Social<br/>App</h1>
//           <p className="text-xl opacity-80 font-light">Connect. Share. Discover.</p>
//           <div className="mt-10 flex gap-4 justify-center">
//             {['🌍','💬','❤️','📸'].map((e,i) => (
//               <div key={i} className="w-12 h-12 rounded-2xl bg-white bg-opacity-20 flex items-center justify-center text-2xl backdrop-blur-sm">{e}</div>
//             ))}
//           </div>
//         </div>
//       </div>
...
//             <h2 className="text-4xl font-black mb-2" style={{ color: 'var(--primary)' }}>Welcome back</h2>
...
//             </div>
//             <div>
//               <label className="block text-sm font-semibold mb-2" style={{ color: 'var(--primary)' }}>Password</label>
