...
//         title: 'Comment added!', showConfirmButton: false, timer: 1500 });
...
//           <img src={`https://ui-avatars.com/api/?name=${c.author.username}&size=32&background=random`}
//             className="w-7 h-7 rounded-full" alt={c.author.username} />
//           <div className="rounded-xl px-3 py-2 text-sm flex-1" style={{ background: 'var(--accent)' }}>
//             <span className="font-bold" style={{ color: 'var(--secondary)' }}>{c.author.username} </span>
//             <span className="dark:text-gray-800">{c.text}</span>
//           </div>
//         </div>
//       ))}
//       <form onSubmit={handleSubmit} className="flex gap-2 mt-2">
//         <input value={text} onChange={e => setText(e.target.value)} placeholder="Add a comment..."
//           className="flex-1 border rounded-xl px-3 py-2 text-sm outline-none dark:bg-gray-800 dark:text-white"
//           style={{ borderColor: 'var(--accent)' }}
//           onFocus={e => e.target.style.borderColor = 'var(--primary)'}
//           onBlur={e => e.target.style.borderColor = 'var(--accent)'} />
//         <button type="submit" className="px-4 py-2 rounded-xl text-white text-sm font-bold"
